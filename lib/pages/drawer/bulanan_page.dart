...
class BulananPage extends StatelessWidget {
  BulananPage({Key? key}) : super(key: key);
        ...
        child: ListView(
          children: [
            StreamBuilder<QuerySnapshot>(
              stream: task.where('user', isEqualTo: tc.username.value).where('kategori', isEqualTo: "bulanan").snapshots(),
              builder: (_, snapshot) {
