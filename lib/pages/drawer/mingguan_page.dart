...
class MingguanPage extends StatelessWidget {
  MingguanPage({Key? key}) : super(key: key);
        ...
        child: ListView(
          children: [
            StreamBuilder<QuerySnapshot>(
              stream: task.where('user', isEqualTo: tc.username.value).where('kategori', isEqualTo: "mingguan").snapshots(),
              builder: (_, snapshot) {
